...
fun WeekLeadingProgressView() {
    val leading1 = WeeklyIndicatorProgressModel(
        progress = 0.33f, amountAndGoal = "24.4 млн./100 млн.", title = stringResource(
            R.string.leading1
        )
    )
    val leading2 = WeeklyIndicatorProgressModel(
        progress = 0.9f, amountAndGoal = "30.4 млн./40 млн.", title = stringResource(
            R.string.leading2
        )
    )
    val leading3 = WeeklyIndicatorProgressModel(
        progress = 0.33f, amountAndGoal = "21.4 млн./100 млн.", title = stringResource(
            R.string.leading3
        )
    )
